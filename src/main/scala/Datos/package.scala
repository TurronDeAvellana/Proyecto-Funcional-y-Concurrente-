package object Datos {
  ...
  //Cod: Codigo del aeropuerto
  //X,Y: Coordenadas en el plano donde esta ubicado el aeropuerto
  //GMT: Franja horaria con respecto al meridiano de greenwich

  case class Vuelo(Aln: String, Num: Int, Org: String, HS:Int, MS:Int, Dst:String, HL:Int, ML: Int, Esc: Int)
  //Aln: Aerolinea
  //Num: Numero de vuelo
  //Org: Codigo del aeropuerto de origen
  //HS:MS: Hora local de salida del vuelo
  //Dst: codigo del aeropuerto de llegada
  ...
  val vuelosCurso = List(
    ...
    //Vuelo("AVA", 4322, "SMR", 9, 30, "SMR", 10, 0, 0),
